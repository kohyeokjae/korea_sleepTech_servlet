...
public class UserServlet extends HttpServlet {
    ...
    private void insertUser(HttpServletRequest request, HttpServletResponse response)
        ...
        // : 자바 서블릿에서 클라이언트에게 다른 페이지로 이도을 명령하는 기능
        response.sendRedirect("list"); // '/list'로 이동하도록 명령 (내부적으로 새로운 요청을 발생시키는 방식)
    }

    // 3. 기본 사용자 정보 수정 폼을 보여주는 메스드
